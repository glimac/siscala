 ...
 */
class Ala extends \Adm\Entity\Ala implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getAlacodigo()
    {
        if ($this->__isInitialized__ === false) {
            return (int) $this->_identifier["alacodigo"];
        }
        $this->__load();
    ...
    {
        $this->__load();
        return parent::setAladescricao($aladescricao);
    }

    public function getAladescricao()
    {
        $this->__load();
        return parent::getAladescricao();
    }

    public function setEsccodigo(\Adm\Entity\Escala $esccodigo = NULL)
    {
        $this->__load();
        return parent::setEsccodigo($esccodigo);
    }
    ...
    {
        return array('__isInitialized__', 'alacodigo', 'aladescricao', 'esccodigo');
    }
