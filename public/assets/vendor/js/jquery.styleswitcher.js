...
if($.cookie("theme")) {
	...
	$("link.theme").attr("href",("assets/vendor/css/theme/" + $.cookie("theme") + ".css"));
};

// Checks if you've set a width already
if($.cookie("width")) {
	// Sets the width that the cookie finds
	$("link.width").attr("href",("assets/vendor/css/" + $.cookie("width") + ".css"));
};
...
$(document).ready(function() { 
	...
	$("#style li a").click(function() { 
		...
		var $theme = "assets/vendor/css/theme/" + ($(this).attr('href').replace("#","")) + ".css";
...
//-------------------------------------------------------------- */
	...
	$("#width li a").click(function() { 
		...
		var $widthCss = "assets/vendor/css/" + ($(this).attr('href').replace("#","")) + ".css";
