...
(function(i, wa, p) {
    ...
    o.ofnSearch = {};
    o.afnSortData = [];
    o.oStdClasses = {sPagePrevEnabled: "paginate_enabled_previous", sPagePrevDisabled: "paginate_disabled_previous", sPageNextEnabled: "paginate_enabled_next", sPageNextDisabled: "paginate_disabled_next", sPageJUINext: "", sPageJUIPrev: "", sPageButton: "paginate_button", sPageButtonActive: "paginate_active",
    ...
    o.oSort = {"string-asc": function(g, l) {
            if (typeof g != "string")
                g = "";
            if (typeof l != "string")
                l = "";
    ...
    i.fn.dataTable = function(g) {
        function l() {
            ...
            this.aanFeatures = [];
                this.oLanguage = {sProcessing: "Processamento...", sLengthMenu: "Mostrar _MENU_ registros", sZeroRecords: "Nenhum registro correspondente localizado.", sEmptyTable: "Não há dados disponíveis na tabela.",
                sLoadingRecords: "Carregando...", sInfo: "Mostrando _START_ - _END_ de _TOTAL_ registros", sInfoEmpty: "Mostrando 0 - 0 de 0 registros", sInfoFiltered: "(filtrado a partir _MAX_ total registros)", sInfoPostFix: "", sSearch: "Pesquisa:", sUrl: "", oPaginate: {sFirst: "Primeiro", sPrevious: "Anterior", sNext: "Próximo", sLast: "Último"}, fnInfoCallback: null};
            this.aoData = [];
            this.aiDisplay = [];
            ...
            this.iNextId = 0;
            this.asDataSearch = [];
            this.oPreviousSearch = {sSearch: "", bRegex: false,
                bSmart: true};
            ...
            this.fnServerData = function(a, b, c, d) {
                d.jqXHR = i.ajax({url: a, data: b, success: c, dataType: "json", cache: false, error: function(f, e) {
        ...
        function s(a) {
            ...
            if (a.bInitialised === false)
                ...
                if (a.sAjaxSource !== null && !a.oFeatures.bServerSide)
                    a.fnServerData.call(a.oInstance, a.sAjaxSource, [], function(f) {
                        var e = f;
                        if (a.sAjaxDataProp !== "")
        ...
        function G(a, b) {
            ...
            b = {sType: null, _bAutoType: true, bVisible: true, bSearchable: true, bSortable: true, asSorting: ["asc", "desc"],
        ...
        function v(a, b) {
            ...
            for (var f, e = 0, h = a.aoColumns.length; e < h; e++) {
                c = a.aoColumns[e];
                typeof c.fnRender == "function" && c.bUseRendered && c.mDataProp !== null && N(a, b, e, c.fnRender({iDataRow: b, iDataColumn: e,
        ...
        function z(a, b) {
            ...
            if (c.nTr === null) {
                ...
                for (var f =
                    ...
                    d.innerHTML = typeof h.fnRender == "function" && (!h.bUseRendered || h.mDataProp === null) ? h.fnRender({iDataRow: b, iDataColumn: f, aData: c._aData, oSettings: a}) : H(a, b, f, "display");
                    if (h.sClass !== null)
            ...
            for (f = a.aoColumns.length; d < f; d++) {
                ...
                if (j || m || e || !k) {
                    ...
                    for (c = a.aoData.length; b < c; b++) {
                        ...
                        if (m) {
                            q = a.aoColumns[d].fnRender({iDataRow: b, iDataColumn: d, aData: a.aoData[b]._aData, oSettings: a});
                            t.innerHTML = q;
        ...
        function R(a, b) {
            ...
            if ((typeof b ==
                    "undefined" || b) && !a.oFeatures.bDeferRender)
                T(a);
            a.bSorted = true;
